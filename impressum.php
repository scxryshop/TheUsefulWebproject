...
<head>
    ...
    <link href="css/impressum.css" type="text/css" rel="stylesheet">
    <?php require_once 'head.inc.php'; ?>
    <title>Linked Websites - Impressum</title>
</head>
<body>
    <h1>Impressum</h1>
    ...
    <div class="content">
        <article>
            <b><h3>Kontakt</h3></b>
            <a  href="mailto:info@websiteslink.com">E-mail: info&#64;websiteslink.com</a>
        </article>
        <br>
        <article>
            <b><h3>Haftung f&uuml;r Inhalte</h3></b>
            <p>Als Diensteanbieter sind wir gem&auml;&szlig; § 7 Abs.1 TMG f&uuml;r eigene Inhalte auf diesen Seiten nach den<br> 
                allgemeinen Gesetzen verantwortlich.
                Nach §§ 8 bis 10 TMG sind wir als Diensteanbieter jedoch nicht<br> 
                verpflichtet, &uuml;bermittelte oder gespeicherte fremde Informationen zu &uuml;berwachen oder nach Umst&auml;nden zu<br> 
                forschen, die auf eine rechtswidrige T&auml;tigkeit hinweisen.<br><br> 
        ...
        <br>
        <article>
            <b><h3>Haftung f&uuml;r Links</h3></b>
            <p>Unser Angebot enth&auml;lt Links zu externen Websites Dritter, auf deren Inhalte wir keinen Einfluss haben.<br>
                ...
                Seiten wurden zum Zeitpunkt der Verlinkung auf m&ouml;gliche Rechtsverst&ouml;&szlig;e &uuml;berpr&uuml;ft. Rechtswidrige Inhalte<br>
            ...
            <p> Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere für Schäden, die aus der Nutzung oder Nichtnutzung solcherart <br> dargestellten Informationen entstehen, haftet allein der Diensteanbieter <br> der Seite, auf welche verwiesen wurde, nicht derjenige, der über Links auf die jeweilige Veröffentlichung lediglich verweist.</p>
        </article>
        <br>
        <article>
            <b><h3>Urheberrecht</h3></b>
